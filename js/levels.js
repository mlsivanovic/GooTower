...
export const LEVELS = [
  ...
  },
  {
    id: 'iznad-oblaka',
    name: 'Iznad oblaka',
    sub: 'Vetar i baloni te dižu iznad oblaka do visoke cevi.',
    required: 6,
    total: 18,
    wind: 200,
    balloons: [[120, 645], [180, 645], [240, 645]],
    platforms: [
      { x: -200, y: 660, w: 1680, h: 260 },
    ],
    killY: 1000,
    pipe: { x: 1060, y: 150, dir: 'down' },
    initial: {
      nodes: [[200, 645], [340, 645], [270, 540]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#1b2a4a', '#42618f'],
    hills: [
      { color: '#2a3a5c', y: 560, amp: 50, freq: 1.5 },
      { color: '#1c2942', y: 610, amp: 32, freq: 2.2 },
    ],
    ground: '#161f33',
    groundTop: '#33507e',
    decor: { sun: null, stars: 22, clouds: 3 },
  },
  {
    id: 'zvezdani-most',
    name: 'Zvezdani most',
    sub: 'Osloni most na platformu koja klizi kroz zvezde.',
    hint: 'Pokretna platforma nosi čvorove koji na njoj leže. Gradi kada priđe tvojoj obali.',
    required: 9,
    total: 20,
    platforms: [
      { x: -200, y: 600, w: 520, h: 320 },
      { x: 960, y: 560, w: 520, h: 360 },
    ],
    movers: [
      { x: 380, y: 540, w: 180, h: 26, toX: 740, toY: 540, period: 4.2 },
    ],
    killY: 880,
    pipe: { x: 1050, y: 455, dir: 'left' },
    initial: {
      nodes: [[185, 585], [320, 585], [252, 478]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#241a44', '#5a5390'],
    hills: [
      { color: '#2e2456', y: 515, amp: 56, freq: 1.3 },
      { color: '#1f1838', y: 578, amp: 34, freq: 2.0 },
    ],
    ground: '#1b1533',
    groundTop: '#3d3168',
    decor: { sun: null, stars: 26 },
  },
  {
    id: 'vrata-vetra',
    name: 'Vrata vetra',
    sub: 'Otvori kapiju, pa pusti da te vetar prenese kroz prolaz.',
    hint: 'Pritisni narandžastu ploču da otvoriš kapiju. Zatim iskoristi vetar da produžiš most preko procepa.',
    required: 10,
    total: 22,
    wind: 160,
    platforms: [{ x: -200, y: 660, w: 1680, h: 260 }],
    switches: [{ id: 'vetrokaz', x: 430, y: 650, w: 110, latch: true }],
    gates: [{ x: 700, y: 250, w: 62, h: 420, toY: -180, switch: 'vetrokaz' }],
    killY: 1000,
    pipe: { x: 1040, y: 520, dir: 'left' },
    initial: {
      nodes: [[175, 645], [315, 645], [245, 540]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#182338', '#4a6272'],
    hills: [
      { color: '#22303f', y: 540, amp: 46, freq: 1.4 },
      { color: '#161f2b', y: 598, amp: 29, freq: 2.1 },
    ],
    ground: '#141b24',
    groundTop: '#33475a',
    decor: {
      sun: null, stars: 18, particles: 'snow',
      props: [{ type: 'tower', x: 90, y: 660, s: 70 }, { type: 'chimney', x: 1170, y: 660, s: 50 }],
    },
  },
  {
    id: 'lebdeci-vrt',
    name: 'Lebdeći vrt',
    sub: 'Ventilator i baloni te nose, ali čuvaj se sečiva u struji.',
    hint: 'Struja ventilatora diže lagane čvorove i balone. Vodi konstrukciju pored sečiva do visoke cevi.',
    required: 9,
    total: 22,
    balloons: [[120, 645], [180, 645]],
    platforms: [
      { x: -200, y: 660, w: 1680, h: 260 },
      { x: 700, y: 420, w: 150, h: 240 },
    ],
    fans: [
      { x: 260, y: 90, w: 790, h: 520, fx: 520, fy: -520 },
    ],
    hazards: [{ x: 640, y: 300, r: 26 }],
    killY: 1000,
    pipe: { x: 1040, y: 245, dir: 'left' },
    initial: {
      nodes: [[180, 645], [320, 645], [250, 540]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#132a2e', '#2f5d55'],
    hills: [
      { color: '#1c3f3a', y: 535, amp: 48, freq: 1.4 },
      { color: '#122b28', y: 596, amp: 30, freq: 2.1 },
    ],
    ground: '#101f1d',
    groundTop: '#2c5a4c',
    decor: {
      sun: null, stars: 14, particles: 'leaves',
      props: [{ type: 'roots', x: 90, y: 660, s: 66 }, { type: 'roots', x: 1160, y: 660, s: 60 }],
    },
  },
  {
    id: 'ledeni-tornjevi',
    name: 'Ledeni tornjevi',
    sub: 'Plutaj po ledenoj vodi, uhvati pokretnu platformu, prkosi vetru.',
    hint: 'Voda te drži na površini — pluta do srednjeg ostrva, pa tempiraj pokretnu platformu uz vetar.',
    required: 11,
    total: 25,
    wind: 140,
    platforms: [
      { x: -200, y: 600, w: 470, h: 320 },
      { x: 560, y: 520, w: 190, h: 400 },
      { x: 1010, y: 600, w: 470, h: 320 },
    ],
    liquids: [
      { type: 'water', x: 300, y: 500, w: 260, h: 220 },
    ],
    movers: [
      { x: 770, y: 500, w: 170, h: 26, toX: 850, toY: 430, period: 3.8 },
    ],
    killY: 900,
    pipe: { x: 1080, y: 300, dir: 'left' },
    initial: {
      nodes: [[160, 585], [290, 585], [225, 480]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#16324d', '#5b86a8'],
    hills: [
      { color: '#204863', y: 500, amp: 58, freq: 1.3 },
      { color: '#152f45', y: 570, amp: 34, freq: 2.0 },
    ],
    ground: '#122536',
    groundTop: '#31607f',
    decor: {
      sun: null, stars: 20, particles: 'snow',
      props: [{ type: 'tower', x: 1130, y: 600, s: 78 }, { type: 'gear', x: 100, y: 560, s: 54 }],
    },
  },
  {
    id: 'krov-sveta',
    name: 'Krov sveta',
    sub: 'Sve mehanike na jednom mestu — poslednji uspon do cevi.',
    hint: 'Plutaj do srednjeg ostrva i pritisni jezgro da otvoriš kapiju. Zatim iskoristi ventilator i balone da preskočiš lavu i sečivo do cevi.',
    required: 14,
    total: 30,
    platforms: [
      { x: -200, y: 600, w: 500, h: 320 },
      { x: 560, y: 520, w: 210, h: 400 },
      { x: 1030, y: 600, w: 450, h: 320 },
    ],
    liquids: [
      { type: 'water', x: 300, y: 490, w: 240, h: 230 },
      { type: 'lava', x: 780, y: 560, w: 250, h: 160 },
    ],
    fans: [{ x: 760, y: 280, w: 300, h: 280, fx: 600, fy: -260 }],
    switches: [{ id: 'nebo', x: 610, y: 510, w: 105, latch: true }],
    gates: [{ x: 830, y: 220, w: 60, h: 340, toY: -170, switch: 'nebo' }],
    movers: [
      { x: 800, y: 500, w: 170, h: 26, toX: 880, toY: 420, period: 3.6 },
    ],
    balloons: [[80, 585], [135, 585], [190, 585]],
    hazards: [{ x: 905, y: 300, r: 24 }],
    killY: 900,
    pipe: { x: 1110, y: 250, dir: 'left' },
    initial: {
      nodes: [[160, 585], [290, 585], [225, 480]],
      struts: [[0, 1], [0, 2], [1, 2]],
    },
    sky: ['#1a1230', '#6a3a66'],
    hills: [
      { color: '#33203f', y: 500, amp: 62, freq: 1.3 },
      { color: '#1f1428', y: 566, amp: 38, freq: 2.0 },
    ],
    ground: '#181120',
    groundTop: '#4a2f52',
    decor: {
      sun: null, stars: 16, particles: 'embers',
      props: [
        { type: 'reactor', x: 645, y: 420, s: 90 },
        { type: 'tower', x: 1120, y: 600, s: 72 },
        { type: 'gear', x: 95, y: 560, s: 56 },
      ],
    },
  },
];
...
export const CHAPTERS = [
  ...
  { name: 'Iznad oblaka', sub: 'Finalni uspon — sve mehanike na jednom mestu', from: 33, to: 38 },
];
